/* helloworld STAP-compliant task that can run
	- in-browser
		use this script alongside stap.js api2gui library, e.g.
			<html><head><script src="https://cdn.jsdelivr.net/gh/stap7/stapjs@7.16/stap.min.js"><script src=helloworld.js></head><body /></html>
...
var task = {
	...
	//
	//the 2 functions being called that are NOT defined above -- task.display() and task.end() --
