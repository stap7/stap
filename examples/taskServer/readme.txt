 ...
 -- No:
  ...
  Don't have ws and minimist node.js libraries (or not sure)?
    -- Use npm (node.js should have come with npm):
	  ...
	  (if you're having problems installing globally,
	  you can install directly in this folder by skipping the "-g" flag)
  ...
  As an example, assuming you have Python, and sample Python task
	...
	Open helloworld.htm in your web browser.
 
 -- Yes:
  Double-click stap.html to open it in your web browser.
  If your WebSocket service is on port 8719, you'll see your task.
